...
import { ChartNoAxesColumn, Activity } from "lucide-react";
  ...
  return (
    <div className="p-4 bg-surface border border-border-subtle rounded-lg overflow-hidden min-h-100">
      ...
      <div className="grid grid-cols-5 gap-6 my-4">
        ...
        <StatCard label="LLM cost" value={`<$${stats.llmCost.toFixed(1)}`} />
      ...
      {/* Log entries */}
      <div className="border-t mt-4 border-border-subtle">
        {logs.map((log) => (
